				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">ksh $'.$row['product_price'].'</h3>
							...
							<ul class="product-links">
								<li>Share:</li>
								<li><a href="https://www.facebook.com/Aasir_de_franza"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://www.twitter.com/@stephenkarim"><i class="fa fa-twitter"></i></a></li>

								<li><a href="mailto:stephenokeyo004gmail.com"><i class="fa fa-envelope"></i></a></li>
							</ul>
